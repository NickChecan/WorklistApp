		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My Worklist Application",
									"targetURL": "#comnicksampleworklistapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnicksampleworklistapp-display": {
								"semanticObject": "comnicksampleworklistapp",
								"action": "display",
								"description": "A Fiori application created using the worklist template",
								"title": "My Worklist Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.nick.sample.worklistapp",
									"url": sap.ui.require.toUrl("com/nick/sample/worklistapp")
								}
							}
						}
					}
